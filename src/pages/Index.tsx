...
const teamImage = "/urbannest-team.jpg";
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
        ...
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 lg:px-8">
          ...
          >
            ...
            <span>
              ...
              <span className="text-xs font-semibold uppercase tracking-[0.22em] text-primary-foreground/72">
                Realty
              </span>
            </span>
          </a>
          <div className="hidden items-center gap-8 md:flex">
            {navItems.map((item) => (
              <a
                key={item.label}
                href={item.href}
                className="text-sm font-semibold text-primary-foreground/82 transition-colors hover:text-primary-foreground"
              >
                {item.label}
              </a>
            ))}
          ...
          <a
            href="/contact"
            className="hidden sm:inline-flex h-9 items-center justify-center gap-2 rounded-md border border-primary-foreground/35 bg-primary-foreground/10 px-3 text-sm font-medium text-primary-foreground backdrop-blur-md transition-colors hover:bg-primary-foreground/18"
          >
            Schedule a Tour
          </a>
        </nav>
      ...
      >
        <img
          src={heroImage}
          alt="Modern luxury house in Austin, Texas at sunset"
        ...
        <div className="relative z-10 mx-auto flex min-h-[780px] max-w-7xl flex-col justify-end px-5 pb-8 pt-32 md:min-h-[860px] lg:px-8 lg:pb-14">
          <div className="max-w-3xl luxury-reveal">
            <p className="mb-5 inline-flex items-center gap-2 border border-primary-foreground/25 bg-primary-foreground/10 px-4 py-2 text-sm font-semibold text-primary-foreground backdrop-blur-md">
              <Sparkles className="h-4 w-4 text-accent" /> Find Your Perfect
              Space to Live and Invest
            </p>
          ...
          >
            ...
            <Button variant="navy" size="lg" className="h-full min-h-14">
            ...
            {listings.map((listing) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <Button variant="navy" className="mt-5 w-full">
                    View Details
                  </Button>
                </div>
              </article>
      ...
      <section className="bg-primary px-5 py-16 text-primary-foreground lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-5 md:grid-cols-4">
          {features.map(({ icon: Icon, title }) => (
            <div
              key={title}
              className="border border-primary-foreground/14 bg-primary-foreground/6 p-6 transition-colors hover:bg-primary-foreground/10"
            >
      ...
      <section id="about" className="px-5 py-20 lg:px-8 lg:py-28">
        <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="relative">
            <img
              src={teamImage}
              alt="UrbanNest Realty agents in a modern Austin office"
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {propertyTypes.map(({ icon: Icon, label }) => (
                ...
                >
                  ...
                  <h3 className="font-body text-xl font-extrabold text-primary">
                    {label}
                  </h3>
                </div>
              ))}
      ...
      <section id="contact" className="bg-secondary px-5 py-20 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <form className="bg-card p-6 shadow-premium md:p-8">
            <div className="grid gap-4 sm:grid-cols-2">
              <input
                className="border border-input bg-background px-4 py-3 outline-none focus:ring-2 focus:ring-ring"
            ...
            <input
              className="mt-4 w-full border border-input bg-background px-4 py-3 outline-none focus:ring-2 focus:ring-ring"
            ...
            <textarea
              className="mt-4 min-h-32 w-full border border-input bg-background px-4 py-3 outline-none focus:ring-2 focus:ring-ring"
              placeholder="Tell us what you’re looking for"
              aria-label="Message"
            />
            <Button variant="navy" size="lg" className="mt-4 w-full">
              Send Message
            </Button>
          </form>
        </div>
          ...
          <div className="flex gap-3">
            {[Facebook, Instagram, Linkedin, Twitter].map((Icon, index) => (
              <a
                key={index}
                href="#top"
                className="flex h-10 w-10 items-center justify-center border border-primary-foreground/20 transition-colors hover:bg-primary-foreground/10"
